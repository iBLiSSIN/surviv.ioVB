...
document.getElementById("background").style = "filter:brightness(50%);background-image:url(https://surviv.io/img/main_splash.jpg?width=1920&height=1080);";
...
document.getElementById("start-row-header").style = "background-image:https://raw.githubusercontent.com/humphreygaming/surviv-cheat-source/master/src/file/wm04.enc.png";
